...
class ProfilMyDataAdapter(private val listMyDatas: ArrayList<MyData>) :
    RecyclerView.Adapter<ProfilMyDataAdapter.CardViewViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.nav_profil, parent, false)
